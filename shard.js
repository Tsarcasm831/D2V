...
import { getSeededRandom, getShardSeed } from './seeded_random.js';
import { NPC } from './npc.js';
import { Wolf } from './wolf.js';
import { Deer } from './deer.js';
import { Bear } from './bear.js';
import { HumanoidNPC } from './humanoid_npc.js';
import { Pig } from './pig.js';
import { Sheep } from './sheep.js';
import { Chicken } from './chicken.js';
import { AssassinNPC } from './enemy_npc_assassin_1.js';
import { KonohaNinjaNPC } from './konoha_ninja_npc.js';
...
export class Shard {
    ...
    setupEnvironment() {
        ...
        if (h < 0.15) { // Swamp
            texPath = 'swamp_ground_texture.png';
        ...
        const sandTex = wm ? wm.getTexture('swamp_ground_texture.png') : new THREE.TextureLoader().load('swamp_ground_texture.png');
        const dirtTex = wm ? wm.getTexture('dirt_texture.png') : new THREE.TextureLoader().load('dirt_texture.png');
        const grassTex = wm ? wm.getTexture('grass_texture.png') : new THREE.TextureLoader().load('grass_texture.png');
        const snowTex = wm ? wm.getTexture('snow_texture.png') : new THREE.TextureLoader().load('snow_texture.png');
        ...
        if (pendingPond) {
            import('./buildings.js').then(({ Building }) => {
