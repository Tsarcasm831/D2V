...
import { ShardMap } from './shard_map.js';
import { GridLabelManager } from './grid_labels.js';
import { NodeMPManager } from './nodempmanager.js';
import { Building } from './buildings.js';
import { Shard } from './shard.js';
import { SHARD_SIZE } from './world_bounds.js';
import { InputManager } from './input_manager.js';
import { BuildManager } from './build_manager.js';
import { ChatUI } from './player_stubs.js';
...
export class Game {
    ...
    spawnStarterTent() {
        ...
        if (shard) {
            ...
            import('./humanoid_npc.js').then(({ HumanoidNPC }) => {
