...
export class HandBuilder {
    static create(materials: PlayerMaterials, isLeft: boolean, arrays: any) {
        ...
        // 3. THUMB
        // "Over Grip" orientation (Flipped 180)
        const thumbGroup = new THREE.Group();
        thumbGroup.position.set(0.042 * sideMult, 0.02, 0.04);
        
        // Z=2.8 flips it roughly upside down (Geometry -Y becomes +Y Up)
        thumbGroup.rotation.set(0.5, -0.5 * sideMult, 2.8 * sideMult);
