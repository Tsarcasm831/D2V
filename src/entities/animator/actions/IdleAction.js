...
import { playerModelResetFeet, animateBreathing, applyFootRot } from '../AnimationUtils.js';

export class IdleAction {
    static animate(player, parts, damp, skipRightArm = false) {
        ...
        // Leg Splay
        // Male: Slightly wider idle stance (0.15)
        // Female: Standard (0.12)
    ...
    static animateCombatStance(player, parts, damp, t, skipRightArm) {
        const lerp = THREE.MathUtils.lerp;
        const baseHeight = 0.89 * player.config.legScale;
    ...
    static animateArmsIdle(player, parts, damp, t, skipRightArm) {
        const lerp = THREE.MathUtils.lerp;
